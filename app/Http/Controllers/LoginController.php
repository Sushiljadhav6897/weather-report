...
{  
    ...
    public function user_add(Request $request){
       ...
       $result = UserComponent::create($data);
    ...
    public function editUser($id){
        $record = $id;
        $data['records'] = User::where('id',$record)->get();
        //dd($data);
    ...
    public function updateuser(Request $request){
        ...
        $result = UserComponent::update($where,$data);
    ...
    public function user_registeration(Request $request){    
        $request->validate([
           'name' => 'required | string',
           'email' => 'required',
           'password' => 'required | min:10'
       ...
       $result = CityrecordsComponent::create($data);
        return redirect()->route('login')->with("user_registration","user registration successfully");
    }
}
