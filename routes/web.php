...
Route::get('/manageuserdashboard',[LoginController::class,'getuser'])->name('post.update');
Route::get('/edituser/{id}',[LoginController::class, 'edituser']);
Route::post('/changeuser',[LoginController::class, 'updateuser']);
Route::get('/userremove/{id}',[LoginController::class, 'remove']);

Route::get('/register',[LoginController::class,'addPost']);
Route::post('create-post',[LoginController::class,'user_registeration'])->name('user.create');